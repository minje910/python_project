...
print(f"run time: {end - start:.6f}second")
...
s = "1301"
print(f"{s[0]}grade {s[1]}class {( s[2].join(s[3])).lstrip("0") }number")                  # ✅ "1학년 3반 1번" 출력

# 2️⃣ 학번을 슬라이싱만을 이용해서 학년, 반, 번호로 잘라내기
print(f"{s[0:1]}grade {s[1:2]}class {s[2:4].lstrip("0")}number")                  # ✅ "1학년 3반 1번" 출력